...
<html>
    ...
    <body>
        ...
        <h2 id="pepper-name">Reaper Pepper</h2>
        <div class='prod-info'>
		<hr>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                ...
                                <img src='../images/reaper_pepper.png' alt='Guantanamo Pepper'
                     class='img-preview' >
                                </div>
                                <div class='product-img'>
                <img src='../images/reaper_pepper1.jpeg' alt='Guantanamo Pepper'
                     class='img-preview' > 
                                </div>
                                </td>
                        </tr>
            ...
            <div class="prod-detail inline">
                ...
                Grimmer than the grim reaper! If you love to live life on the edge of death than these are for you! It will get you closer death than the grim reaper can take you.
